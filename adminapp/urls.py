...
urlpatterns = [
    ...
    path('attendance_role', views.attendance_role, name='attendance_role'),
    ...
    path('other_attendance',views.other_attendance,name="other_attendance"),
    ...
    path('otherattendance_record', views.otherattendance_record, name='otherattendance_record'),
    ...
    path('appointment_download/', views.appointment_download, name='appointment_download'),
    path('appointment_pdf/<int:id>/', views.appointmentpdf_download, name='appointmentpdf_download'),
    ...
    path('home', views.doctor, name='doctor'),
    ...
    path('search_patients/', views.search_patients, name='search_patient'),
    ...
    path('inhouse_pathpdf', views.inhouse_pathpdf, name='inhouse_pathpdf'),
    path('inhousepharma_pdf', views.inhousepharma_pdf, name='inhousepharma_pdf'),
    ...
    path('housepdf_blood', views.housepdf_blood, name='housepdf_blood'),
    ...
    path('pos_records', views.pos_records, name='pos_records'),
